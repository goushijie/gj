...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "gj@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "gj API";

        private String description = "gj API documentation";
